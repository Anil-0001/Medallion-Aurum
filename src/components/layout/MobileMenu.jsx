...
const mobileMegaItems = [
  ...
  },
  {
    ...
    icon: Camera,
    thumbnails: ["/hero/hero1.jpg", "/hero/hero2.jpg", "/hero/hero5.jpg"],
    cta: "Open Gallery",
  },
  {
    id: "downloads",
    ...
    icon: Download,
    cards: [
      ["Brochure", "Project overview", "/downloads/medallion-aurum-brochure.txt"],
      ["Floor plans", "Layout files", "/downloads/medallion-aurum-floor-plan-site-plan.txt"],
      ["Price plan", "Payment guidance", "/downloads/medallion-aurum-price-payment-plan.txt"],
    ],
    cta: "Get Documents",
  },
  {
